...
class WhatsAppClient {
	...
	async sendMessage(number, message){
		//let actualNumber = number[0] == '5' && number[1] == '5' ? number : 55 + number;
...
async function init(){
	...
	console.log(client.connectionIsOpen)
	await client.startSock()

	setTimeout(()=>{
		console.log(client.connectionIsOpen)
		const number = '5524993199542@s.whatsapp.net'
		console.log("sending message")
		client.sendMessage(5524993199542, 'Hello World 3')
	}, 3000)

	/* if(client.getSocket()){
		client.sendMessage(5524993199542, 'Hello, world')
	} */
	/*
	console.log("GETTING SOCK:")
